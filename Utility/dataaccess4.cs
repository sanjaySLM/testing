...
namespace SouthNests.Phoenix.Framework
{
    public class DataAccess4
    {
        ...
        public static DataSet ExecSPReturnDataSet(string ProcedureName, List<SqlParameter> Parameters)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(DataAccess4.GetConnectionString()))
                {
                    conn.Open();
        ...
        public static string GetConnectionString()
        {
            try
            {
                ...
                return ConfigurationManager.ConnectionStrings[3].ToString();
